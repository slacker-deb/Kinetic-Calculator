...
k=input("Press y if you want to calculate Rate related Items or Press n to other items: ")
if k=='y':
    c=0
    while(c!=5):
    ...
    c=int(input("Press 1 to calculate relations b/w terms\nPress 2 to calculate Sp Cases of First Order Rxn\nEnter Your Choice: "))
    if c==1:
        i=0
        while i<5:
